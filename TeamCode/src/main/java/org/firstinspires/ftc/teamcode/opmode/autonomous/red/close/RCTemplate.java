...
public class RCTemplate {
    ...
    static final Pose SHOOT_POSE = new Pose(109.00581867388361, 112.0155615696888, Math.toRadians(49));
    static final Pose LEAVE_POSE = new Pose(120.26377224619493, 101.91607877167438, Math.toRadians(45));
